...
{
    internal class GoogleCloudProvider : IStorageProvider
    {
        public byte[] RetrieveFile(string fileName)
        {
            Console.WriteLine($"Retrieving {fileName} from Google Cloud...");
        ...
        {
            Console.WriteLine($"Saving {fileName} to Google Cloud...");
